...
const translations = {
  ...
  'create.goLive': { nl: 'Live gaan', en: 'Go Live', srn: 'Go Live' },
  'create.goLiveDesc': { nl: 'Start een livestream voor je volgers', en: 'Start a livestream for your followers', srn: 'Start wan livestream gi yu people' },
  ...
  // Go Live — Preview Screen
  'liveGo.titlePlaceholder': { nl: "Wat gebeurt er nu? ✨", en: "What's happening right now? ✨", srn: 'San e pasa now? ✨' },
  'liveGo.categoryLabel': { nl: 'Kies een categorie', en: 'Choose a category', srn: 'Teki wan categorie' },
  'liveGo.startStreaming': { nl: 'Start livestream', en: 'Start Streaming', srn: 'Start Streaming' },
  'liveGo.needTitleAndCategory': { nl: 'Vul een titel in en kies een categorie', en: 'Add a title and pick a category', srn: 'Poti wan titel èn teki wan categorie' },
  'liveGo.signInRequired': { nl: 'Log in om live te gaan', en: 'Sign in to go live', srn: 'Log in fu go live' },
  'liveGo.permissionNeededTitle': { nl: 'Camera en microfoon nodig', en: 'Camera & mic needed', srn: 'Camera nanga mic mus' },
  'liveGo.permissionNeededDesc': { nl: 'LukuLuku heeft toegang tot je camera en microfoon nodig om live te gaan.', en: 'LukuLuku needs camera and microphone access to go live.', srn: 'LukuLuku mus abi camera nanga mic fu go live.' },
  'liveGo.allowAccess': { nl: 'Toegang geven', en: 'Allow Access', srn: 'Gi Access' },
  'liveGo.openSettings': { nl: 'Instellingen openen', en: 'Open Settings', srn: 'Opo Settings' },
  'liveGo.categoriesError': { nl: 'Categorieën laden mislukt', en: "Couldn't load categories", srn: 'Categorie no lai bun' },
  'liveGo.retry': { nl: 'Opnieuw proberen', en: 'Retry', srn: 'Tra wan tem' },
  'liveGo.readyTitle': { nl: 'Klaar voor de volgende stap', en: 'Ready for the next step', srn: 'Klari gi a next step' },
  'liveGo.readyDesc': { nl: 'De echte livestream (ZegoCloud) komt in de volgende fase.', en: 'The real live broadcast (ZegoCloud) comes in the next phase.', srn: 'A trutru live (ZegoCloud) e kon na next fase.' },

  // Live — streamer's broadcast screen
  'liveHost.live': { nl: 'LIVE', en: 'LIVE', srn: 'LIVE' },
  'liveHost.endStream': { nl: 'Stream beëindigen', en: 'End Stream', srn: 'Kaba a stream' },
  'liveHost.flipCamera': { nl: 'Camera omdraaien', en: 'Flip Camera', srn: 'Drai camera' },
  'liveHost.muteMic': { nl: 'Microfoon dempen', en: 'Mute Mic', srn: 'Tapu mic' },
  'liveHost.unmuteMic': { nl: 'Microfoon aanzetten', en: 'Unmute Mic', srn: 'Opo mic' },
  'liveHost.coHosting': { nl: 'Co-hosting', en: 'Co-Hosting', srn: 'Co-Hosting' },
  'liveHost.battle': { nl: 'Battle', en: 'Battle', srn: 'Battle' },
  'liveHost.endConfirmTitle': { nl: 'Stream beëindigen?', en: 'End stream?', srn: 'Kaba a stream?' },
  'liveHost.endConfirmDesc': { nl: 'Je kijkers zien je dan niet meer live.', en: 'Your viewers will no longer see you live.', srn: 'Yu sma no o si yu live moro.' },
  'liveHost.cancel': { nl: 'Annuleren', en: 'Cancel', srn: 'Libi en' },
  'liveHost.end': { nl: 'Beëindigen', en: 'End', srn: 'Kaba' },

  // Live — chat
  'liveChat.addComment': { nl: 'Voeg een reactie toe...', en: 'Add comment...', srn: 'Poti wan reactie...' },
  'liveChat.joined': { nl: 'is binnengekomen', en: 'joined', srn: 'kon na strim' },
  'liveChat.blocked': { nl: 'Bericht geblokkeerd — houd het netjes.', en: 'Message blocked — keep it clean.', srn: 'Bericht no gowe — hori en krin.' },
  'liveChat.tooLong': { nl: 'Bericht is te lang (max 500 tekens).', en: 'Message is too long (max 500 characters).', srn: 'Bericht bigi tumsi (max 500).' },
  'liveChat.slowModePrefix': { nl: 'Langzame modus:', en: 'Slow mode:', srn: 'Sloifi mode:' },
  'liveChat.slowModeSuffix': { nl: 'sec', en: 's', srn: 'sec' },
  'liveChat.pinned': { nl: 'Vastgezet bericht', en: 'Pinned message', srn: 'Pin bericht' },

  // Live — viewer moderation
  'liveMod.mute': { nl: 'Dempen (15 min)', en: 'Mute (15 min)', srn: 'Tapu (15 min)' },
  'liveMod.kick': { nl: 'Verwijderen (15 min)', en: 'Kick (15 min)', srn: 'Puru (15 min)' },
  'liveMod.ban': { nl: 'Verbannen (volgende stream)', en: 'Ban (next stream)', srn: 'Ban (next stream)' },
  'liveMod.cancel': { nl: 'Annuleren', en: 'Cancel', srn: 'Libi en' },
  'liveMod.mutedDesc': { nl: 'kan 15 minuten niet chatten.', en: 'can’t chat for 15 minutes.', srn: 'no man taki 15 min.' },
  'liveMod.kickedDesc': { nl: 'is verwijderd en kan 15 minuten niet terugkomen.', en: 'was removed and can’t rejoin for 15 minutes.', srn: 'puru èn no man kon bak 15 min.' },
  'liveMod.bannedDesc': { nl: 'is verbannen van je volgende stream.', en: 'is banned from your next stream.', srn: 'ban gi yu next stream.' },
  'liveMod.report': { nl: 'Rapporteren', en: 'Report', srn: 'Report' },
  'liveMod.reportConfirmTitle': { nl: 'Gebruiker rapporteren?', en: 'Report this user?', srn: 'Report a sma disi?' },
  'liveMod.reportConfirmDesc': { nl: 'Ons team bekijkt dit rapport.', en: 'Our team will review this report.', srn: 'Wi team o luku disi report.' },
  'liveMod.reportSubmit': { nl: 'Rapporteren', en: 'Report', srn: 'Report' },
  'liveMod.reportedDesc': { nl: 'is gerapporteerd.', en: 'has been reported.', srn: 'report kaba.' },
  'liveMod.promote': { nl: 'Moderator maken', en: 'Make Moderator', srn: 'Mek Moderator' },
  'liveMod.demote': { nl: 'Moderator verwijderen', en: 'Remove Moderator', srn: 'Puru Moderator' },
  'liveMod.promotedDesc': { nl: 'is nu moderator.', en: 'is now a moderator.', srn: 'na moderator now.' },
  'liveMod.demotedDesc': { nl: 'is geen moderator meer.', en: 'is no longer a moderator.', srn: 'no moderator moro.' },
  'liveMod.badgeHost': { nl: 'HOST', en: 'HOST', srn: 'HOST' },
  'liveMod.badgeModerator': { nl: 'MOD', en: 'MOD', srn: 'MOD' },
  'liveMod.pin': { nl: 'Bericht vastzetten', en: 'Pin message', srn: 'Pin bericht' },
  'liveMod.unpin': { nl: 'Losmaken', en: 'Unpin message', srn: 'Puru pin' },

  // Live Hub — viewer discovery feed
  'liveFeed.title': { nl: 'Live Hub', en: 'Live Hub', srn: 'Live Hub' },
  'liveFeed.searchPlaceholder': { nl: 'Zoek livestreams...', en: 'Search live streams...', srn: 'Suku live streams...' },
  'liveFeed.categoryAll': { nl: 'Alles', en: 'All', srn: 'Ala' },
  'liveFeed.cohostPill': { nl: 'CO-HOSTING', en: 'CO-HOSTING', srn: 'CO-HOSTING' },
  'liveFeed.battlePill': { nl: 'LK BATTLE', en: 'LK BATTLE', srn: 'LK BATTLE' },
  'liveFeed.empty': { nl: 'Niemand is nu live.', en: 'No one is live right now.', srn: 'No wan live now.' },
  'liveFeed.noResults': { nl: 'Geen livestreams gevonden.', en: 'No live streams found.', srn: 'No live stream feni.' },
  'liveFeed.loadError': { nl: 'Live Hub laden mislukt.', en: "Couldn't load Live Hub.", srn: 'Live Hub no ben lai.' },
  'liveFeed.retry': { nl: 'Opnieuw proberen', en: 'Retry', srn: 'Tra wan tem' },
  'liveFeed.openingSoon': { nl: 'De viewer-livestreamscherm komt in de volgende fase.', en: "The viewer's live-stream screen comes in the next phase.", srn: 'A viewer stream screen e kon na next fase.' },

  // Live — viewer screen
  'liveViewer.tapIn': { nl: '+ Tappin', en: '+ Tappin', srn: '+ Tappin' },
  'liveViewer.tappedIn': { nl: 'Getapt ✓', en: 'Tapped ✓', srn: 'Tap kaba ✓' },
  'liveViewer.giftCelebration': { nl: 'heeft een cadeau gestuurd! 🎉', en: 'sent a gift! 🎉', srn: 'send wan present! 🎉' },
  'liveViewer.giftDemoSender': { nl: 'Iemand', en: 'Someone', srn: 'Wan sma' },
  'liveViewer.giftComingSoon': { nl: 'Cadeaus sturen komt binnenkort.', en: 'Gift sending is coming soon.', srn: 'Send present e kon soon.' },
  'liveViewer.streamEnded': { nl: 'Stream beëindigd', en: 'Stream Ended', srn: 'Stream kaba' },
  'liveViewer.exploreMore': { nl: 'Meer ontdekken', en: 'Explore More', srn: 'Luku moro' },
  'liveViewer.goHome': { nl: 'Naar home', en: 'Go Home', srn: 'Go Home' },
  // Labelled "End the Stream" per the user's own wording, but the action is just leaving
  // this viewer's own watch session — a viewer can never end someone else's broadcast.
  'liveViewer.endStream': { nl: 'Stream verlaten', en: 'End the Stream', srn: 'Libi a stream' },

  // Stream categories (slug = stable key from public.stream_categories)
  'streamCategory.just-chatting': { nl: 'Kletsen', en: 'Just Chatting', srn: 'Toktoki' },
  'streamCategory.music': { nl: 'Muziek & DJ', en: 'Music & DJ', srn: 'Musik & DJ' },
  'streamCategory.dance': { nl: 'Dans', en: 'Dance', srn: 'Dansi' },
  'streamCategory.comedy': { nl: 'Comedy', en: 'Comedy', srn: 'Lafu sani' },
  'streamCategory.gaming': { nl: 'Gaming', en: 'Gaming', srn: 'Gaming' },
  'streamCategory.sports': { nl: 'Sport', en: 'Sports', srn: 'Sport' },
  'streamCategory.food': { nl: 'Eten & Koken', en: 'Food & Cooking', srn: 'Nyanyan' },
  'streamCategory.beauty-fashion': { nl: 'Beauty & Mode', en: 'Beauty & Fashion', srn: 'Moi & Krosi' },
  'streamCategory.news-talk': { nl: 'Nieuws & Praten', en: 'News & Talk', srn: 'Njoensu & Taki' },
  'streamCategory.faith': { nl: 'Geloof & Inspiratie', en: 'Faith & Inspiration', srn: 'Bribi & Kra' },
  'streamCategory.education': { nl: 'Educatie', en: 'Education', srn: 'Skoro' },
  'streamCategory.business': { nl: 'Business & Hustle', en: 'Business & Hustle', srn: 'Bisnis' },
  'streamCategory.events': { nl: 'Events & Feesten', en: 'Events & Parties', srn: 'Events & Fesa' },
  'streamCategory.travel': { nl: 'Reizen & Natuur', en: 'Travel & Nature', srn: 'Waka & Natur' },
  'streamCategory.other': { nl: 'Overig', en: 'Other', srn: 'Tra sani' },
